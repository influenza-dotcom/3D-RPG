...
func _can_run() -> bool:
	...
	# typing the Claim key's letter into that menu's search field claims (or begins releasing) whatever the
	# frozen crosshair rests on, popping a NameEntryDialog under the menu. Same guard as WaypointMarker._can_run.
