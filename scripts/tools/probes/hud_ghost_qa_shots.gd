...
##      scripts/tools/probes/__ghost_align_probe.gd measures that seat directly; this shot is how it looks.
...
##      scripts/tools/probes/__stamina_ring_probe.gd pins it and shoots the annulus.)
...
##   & "C:\Users\dalla\bin\godot.cmd" --path . res://scripts/tools/probes/hud_ghost_qa_shots.tscn -- --shots-dir="C:/some/dir"
