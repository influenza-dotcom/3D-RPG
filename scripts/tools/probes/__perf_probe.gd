...
##
##   godot --path "<abs project path>" res://scripts/tools/probes/__perf_probe.tscn -- <variant>
##
	...
	for part in v.split("+"):
		match part:
			...
			"nocull":
				...
				# (scripts/tools/probes/__ink_occlusion_shots.gd does the same A/B on a purpose-built scene.)
