...
##
##   godot --path <absolute project path> -s scripts/tools/probes/preview_fp_body_frame.gd
##
...
const FISTS_PROBE := "res://scripts/tools/probes/preview_fists_frame.gd"
...
const POSE_PROPS := ["fp_leg_offset", "fp_leg_scale", "fp_torso_offset", "fp_body_arm_offset",
		...
		# scripts/tools/probes/__ink_cb_ring_shots.gd, which is windowed and self-judging. Keep one of them alive:
