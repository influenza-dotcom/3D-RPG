...
##   godot --path <abs project> res://scripts/tools/probes/__prewarm_visibility_probe.tscn
...
##
## Sibling instrument: scripts/tools/probes/__first_kill_hitch_probe.gd measures whether the warm still WORKS (pipeline
