...
## alarm instead of being free. In the &"corpse" group (a cheap scan target for NPC._sense_corpses); marks
...
## Once true, NPCs stop reacting to this body. Flipped by the FIRST NPC that notices it (NPC._sense_corpses),
...
## nodes or transform reads; the live scan (NPC._sense_corpses) adds a line-of-sight ray on top of this.
